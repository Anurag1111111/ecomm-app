  ...
  return (
    <Consumer>
      {(value) => {
        ...
        const shoe = Shoes.filter((shoe) => shoe.id == id)[0];
        const {
          imageUrl,
          title,
          price,
              ...
              <div className="col-12 col-md-6">
                <div className="text-left pt-4">
                  ...
                  <div className="d-flex align-items-center py-3">
                    ...
                    <select
                      className="custom-select mx-4 h-100 mb-0"
                      id="inputGroupSelect02"
                    >
                      <option defaultValue={3}>Choose...</option>
...
export default ProductShoePage;
